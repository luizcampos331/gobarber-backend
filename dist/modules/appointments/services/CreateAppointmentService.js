...
var _IApointmentsRepository = _interopRequireDefault(require("../repositories/IApointmentsRepository"));
...
let CreateAppointmentservice = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec5 = Reflect.metadata("design:type", Function), _dec6 = Reflect.metadata("design:paramtypes", [typeof _IApointmentsRepository.default === "undefined" ? Object : _IApointmentsRepository.default, typeof _INotificationsRepository.default === "undefined" ? Object : _INotificationsRepository.default, typeof _ICacheProvider.default === "undefined" ? Object : _ICacheProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = class CreateAppointmentservice {
  ...
  async execute({
    ...
    } // Salva um novo appointment no banco de dados
    ...
    await this.cacheProvider.invalidate(`provider-appointmens:${provider_id}:${(0, _dateFns.format)(appointmentDate, 'yyyy-M-d')}`);
    return appointment;
  }
